...
public class Day10Part1 {
    ...
    public Day10Part1(List<Point> points) {
        this.points = points;
    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        Day10Part1 day10Part1 = getInput(CommonUtils.getInputFile(INPUT_FILE));

        String image = day10Part1.calculate();
        System.out.println(image);
    }

    private static Day10Part1 getInput(String path) throws FileNotFoundException {
