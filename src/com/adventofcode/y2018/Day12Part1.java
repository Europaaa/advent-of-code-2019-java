...
public class Day12Part1 {
    ...
    public Day12Part1(Pot[] pots, List<Rule> rules) {
        this.pots = pots;
        this.rules = rules;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        Day12Part1 day12Part1 = getInput(CommonUtils.getInputFile(INPUT_FILE));
    ...
    private static Day12Part1 getInput(String path) throws FileNotFoundException {
        try (Scanner scanner = new Scanner(new File(path))) {
            ...
            return new Day12Part1(pots, rules);
        }
    }
}
