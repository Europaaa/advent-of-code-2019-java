...
public class Day9Part1 {
    ...
    public Day9Part1(int numPlayer, long maxMarbleId) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        Day9Part1 day9Part1 = getInput(CommonUtils.getInputFile(INPUT_FILE));

        long score = day9Part1.calculate();
        System.out.println(score);
    }

    private static Day9Part1 getInput(String path) throws FileNotFoundException {
        try (Scanner scanner = new Scanner(new File(path))) {
            ...
            return new Day9Part1(Integer.parseInt(matcher.group(1)), Long.parseLong(matcher.group(2)));
        }
    }
}
