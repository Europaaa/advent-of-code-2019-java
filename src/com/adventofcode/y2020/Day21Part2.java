...
public class Day21Part2 {
    ...
    public Day21Part2 add(Set<String> ingredients, Set<String> allergens) {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        Day21Part2 day21Part1 = getInput(CommonUtils.getInputFile(INPUT_FILE));

        Map<String, String> mappings = day21Part1.reduce();

        String result = mappings.entrySet().stream()
    ...
    private static Day21Part2 getInput(String path) throws FileNotFoundException {
        try (Scanner scanner = new Scanner(new File(path))) {
            Day21Part2 day21Part1 = new Day21Part2();
