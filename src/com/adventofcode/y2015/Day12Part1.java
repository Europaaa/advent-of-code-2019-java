...
public class Day12Part1 {
    ...
    private static long evaluate(Object json) {
        ...
        if (json instanceof List) {
            return ((List) json).stream().mapToLong(Day12Part1::evaluate).sum();
        }
        if (json instanceof Map) {
            return ((Map) json).values().stream().mapToLong(Day12Part1::evaluate).sum();
        }
    ...
    private static Object getInput(String path) throws IOException {
